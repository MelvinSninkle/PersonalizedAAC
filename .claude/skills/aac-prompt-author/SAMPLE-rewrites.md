...
- **After:** `A {style}, photographic, of a real kitchen refrigerator standing open, the door swung wide so the shelves are visible inside — a carton of eggs, a jug of milk, bright fruit and vegetables, a few jars on the door. Everyday home kitchen, not a showroom.`
...
- **After:** `A {style}, photographic, of a child's plastic cup with a little juice in it, sitting on a kitchen table. A plain everyday cup — absolutely no face, eyes, or smile on it.`
...
- **After:** `A {style}, photographic, of an open child's lunchbox on a table, showing the food inside — a sandwich cut in half, apple slices, a few crackers, a small drink. The real packed-lunch version, not an empty container.`
...
- **After:** `A {style}, photographic, of {reference} lifting the lid straight off a glass jar with both hands, the lid raised above the jar. A clear UP arrow beside the lid showing the opening motion. Same kitchen-table setup as "close".`
...
- **After:** `A {style}, photographic, of {reference} pressing the lid down onto the same glass jar with both hands, lid seated on top. A clear DOWN arrow beside the lid showing the closing motion. Same kitchen-table setup as "open".`
...
- **After:** `A {style}, photographic, of {reference} taking a bite of a sandwich at the kitchen table, both hands holding it, mid-bite and clearly enjoying it.`
- roles_present: `[child]` · objects_present: `[sandwich]`

### verbs.social.share — "share" (verb, child + peer)
- **After:** `A {style}, photographic, of {reference} handing one of two cookies across a small table to a peer (another child the same age), both reaching toward the same cookie.`
...
- **After:** `A {style}, photographic, of {reference} holding a big beach ball that fills their arms, standing next to a tiny ball on the floor for scale. Same setup as "little"; here the BIG ball is the focus.`
...
- **After:** `A {style}, photographic, of {reference} holding a tiny ball pinched between two fingers, the big beach ball resting on the floor beside them for scale. Same setup as "big"; here the LITTLE ball is the focus.`
...
- **After:** `A {style}, photographic, of a child's bicycle with training wheels parked on a driveway, helmet hanging on the handlebars. The everyday kid's bike, not an adult road bike.`
